...
var moment = require("moment"); //Print Date or Time in the following format:


console.log("Current Date and Time: " + moment().format('MMMM Do YYYY, h:mm:ss a'));
console.log("Current Day: " + moment().format('dddd'));
console.log("Current Date: " + moment().format("MMM Do YY")); //Check if the following date is valid or not:

var date1 = moment("2020-01-01");
console.log("Date 2020-01-01 is valid: " + date1.isValid());
var date2 = moment("2020-14-01");
console.log("Date 2020-14-01 is valid: " + date2.isValid()); // Manipulating Dates
...
console.log("Subtracting 7 years: " + moment().subtract(7, 'years').calendar()); // Find the difference between the following 2 dates:
...
console.log(" Is 2020 leap year: " + moment([2020]).isLeapYear()); //Use lodash to do the following things:
//Array Methods

console.log("Using drop method: " + lodash.drop([1, 2, 3, 4, 5, 6], 2));
console.log("Using difference method: " + lodash.difference([1, 2, 3, 4, 5, 6], [2, 8]));
console.log("Using concat method: " + lodash.concat([1, 2, 3], [4, 5, 6]));
console.log("Using compact method: " + lodash.compact([0, 2, false, 4, "", 6], 2));
console.log("Using chunk method: " + lodash.drop(["1", "2", "3", "4", "5", "6"], 2));
console.log("Using flattenDeep method: " + lodash.flattenDeep([1, [2, [3, [4]], 5]])); //Collection Methods

console.log("Using countBy method: " + lodash.countBy([6.1, 4.2, 6.3], Math.floor));
console.log("Using forEach method: " + lodash.forEach({
  'a': 1,
  'b': 2
}, function (value, key) {
  return key;
